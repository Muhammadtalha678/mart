...
import {addproductController, deletesingleproductController, getallproductController,getsingleproductController, updatesingleproductController} from '../controllers/product_controller.js'
...
router.put('/products/:id',AuthorizeUser,AuthorizeAdminMiddleware,uploadImages,
    validateRequest(productValidation),updatesingleproductController)
